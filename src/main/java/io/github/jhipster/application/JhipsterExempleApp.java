...
public class JhipsterExempleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterExempleApp.class);

    private final Environment env;

    public JhipsterExempleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterExemple.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterExempleApp.class);
